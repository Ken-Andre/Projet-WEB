...
@section('content')
    ...
    <div class="untree_co-hero" style="background-image: url('{{asset('images/hero_bg_5.jpg')}}');">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 text-center text-lg-center">
                    <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100"><a>Shop in our Store</a></h1>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-4">
                    <div class="d-flex sort align-items-center justify-content-lg-end">
                        ...
                        <form method="GET" action="{{route('category_products',['category'=>$category])}}">
            ...
            <div class="container">
                ...
                <div class="owl-3-slider owl-carousel">
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                ...
                                <img src="{{asset('images/cloth_1.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;" >
                            </a>
                    ...
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                ...
                                <img src="{{asset('images/cloth_2.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;">
                            </a>
                    ...
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                <img src="{{asset('images/watch_1.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;">
                            </a>
                    ...
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                <img src="{{asset('images/shoe_2.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;">
                            </a>
                    ...
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                <span class="custom-badge sale">Sale</span>
                                <img src="{{asset('images/cloth_3.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;">
                            </a>
                    ...
                    <div class="item">
                        <div class="product-item">
                            <a href="{{route('shop_single')}}" class="product-img">
                                <span class="custom-badge sale">Sale</span>
                                <img src="{{asset('images/shoe_1.jpg')}}" alt="Image" class="img-fluid" style="height: 200px; width: 250px;">
                            </a>
