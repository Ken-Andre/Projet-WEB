        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 text-center text-lg-center">
                    <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Shop in our Store</a></h1>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled categories">
                        <li><a href="{{route('category_products',['category'=>"accesories"])}}">Accesories<span>2,919</span></a></li>
                        <li><a href="{{route('category_products',['category'=>"electronics"])}}">Electronics<span>5,381</span></a></li>
                        <li><a href="{{route('category_products',['category'=>"drink"])}}">Drink<span>7,119</span></a></li>
                        <li><a href="{{route('category_products',['category'=>"alimentation"])}}">alimentation <span>1,012</span></a></li>
                        ...
                        @foreach($products as $product)
                            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
                                <div class="product-item">
                                    ...
                                    <button class="bg-black-500 text-white p-2">Ajouter au panier</button>
                                </div>
                            </div>
                        @endforeach
